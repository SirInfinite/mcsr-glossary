...
Tested implementation checkpoint: `0f45b17`
...
| --- | ---: | ---: | ---: | ---: |
| Performance | 76 | 89 | 87 | 100 |
| Accessibility | 100 | 100 | 100 | 100 |
| Best Practices | 100 | 100 | 96 | 100 |
| SEO | 100 | 100 | 100 | 100 |
| FCP | 3.6 s | 2.1 s | 2.1 s | 0.5 s |
| LCP | 4.4 s | 3.4 s | 3.7 s | 0.7 s |
| TBT | 0 ms | 80 ms | 70 ms | 0 ms |
...
Normal local flows completed with zero JavaScript exceptions, no missing local assets, and no CSP failures. Expected network errors appeared only during deliberate Supabase blocking. YouTube and Twitch iframes initialize automatically and lazily from explicit CSP hosts; no provider SDK or unsupported embed script is loaded.
